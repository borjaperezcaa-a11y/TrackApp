...
export const ICON_PATHS = {
  ...
  // Cabeza tractora europea (frontal plano, cabina alta) + remolque y dos ejes.
  rig: '<path d="M1 8h11v7H1z"/><path d="M12 15V4h5a1.5 1.5 0 0 1 1.5 1.5V15z"/><path d="M12.5 8h6"/><circle cx="5" cy="17.5" r="2"/><circle cx="15.5" cy="17.5" r="2"/>',
